async def show_dwarves(channel):
    ...
    ingor = '**Ingór I the Cruel**: "How much more can your mortal form take?" - ' \
            'Applies 1 stack of incoming healing debuff.\n'
    oiko2 = '**Óiko II Rill-Seeker**: "I seek the mithril stream." - Ice line\n'
    dobruz = '**Dóbruz IV the Unheeding**: "You look like a weakling."/"I challenge YOU!" - ' \
    ...
    dobruz2 = '**Dóbruz II Stark-heart**: "The Zhelruka clan is mine to protect." - ' \
